...
@NgModule({
  declarations: [BetsHomeComponent, DatepickerI18nComponent, ListBetsComponent, BetComponent],
  imports: [CommonModule, BetsRoutingModule, FormsModule, NgbModule, SharedModule]
})
